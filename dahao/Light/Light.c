...
{
	HC595_LedWriteData(0x0004|0x0008|0x0200|0x0001|0x0040);
}
/****************************************************************************************************
**Function:
...
{	
	...
	{
		Light_BkComBuf[LIGHT_KEY_LIGHT].Hc595dat = 0xfff;
		HC595_LedWriteData(Light_BkComBuf[LIGHT_KEY_LIGHT].Hc595dat|(((uint16)TouchLightFlag.byte)<<12));
	}
}
/****************************************************************************************************
...
{
	Light_BkComBuf[LIGHT_KEY_LIGHT].Hc595dat = (~Light_BkComBuf[LIGHT_KEY_LIGHT].Hc595dat)&0X0FFF;
	HC595_LedWriteData(Light_BkComBuf[LIGHT_KEY_LIGHT].Hc595dat|(((uint16)TouchLightFlag.byte)<<12));
